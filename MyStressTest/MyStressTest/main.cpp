...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	for (int i = 0; i < NUM_OF_NPC; i++)
	{
		...
		x1 = (float)(x - 150) * 0.005f;
		y1 = (float)(y - 150) * 0.005f;
		z1 = -1.0f;
	...
	glPrint("HERO TEST [%d]", cuser);	// Print GL Text To The Screen

	glColor3f(1, 0.5f, 1);
	glRasterPos2f(0.0, -0.4f);
	glPrint("MONSTER TEST [%d]", monster);	// Print GL Text To The Screen
	...
	int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow(L"NeHe's Bitmap Font Tutorial", 600, 600, 16, fullscreen))
	{
